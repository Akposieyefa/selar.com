        ...
        <div class="md:w-11/12 md:mx-auto">
            ...
            <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                <div class="font-semibold bg-gray-200 text-gray-700 py-3 px-6 mb-0">
                   @user {{'My Wallet'}} @else {{"Customers Wallets"}}  @enduser
                </div>
                                            ...
                                            <td class="py-4 px-6 border-b border-grey-light text-center">
                                                <div class="container text-center mx-auto p-5">
                                                    <div class="flex justify-center rounded-lg text-lg mb-4">
                                                        @user
                                                        <a href="{{route('wallets.show', $value->id)}}" class="bg-blue-500 text-white hover:bg-blue-400  px-4 py-2 mx-0 outline-none focus:shadow-outline">More </a> &nbsp
                                                        <a href="{{route('wallets.edit', $value->id)}}"  class="bg-pink-500 text-white hover:bg-pink-400  px-4 py-2 mx-0 outline-none focus:shadow-outline">Edit </a> &nbsp
                                                        @enduser
